...
| Die drei Rechtsseiten | `app/legal/impressum`, `app/legal/agb`, `app/legal/widerruf` | Die Texte sind Entwürfe aus der Konfiguration und ersetzen keine Rechtsberatung. Impressum, AGB und Widerrufsbelehrung samt Muster-Widerrufsformular anwaltlich prüfen und freigeben lassen. Eine Datenschutzerklärung fehlt noch komplett und muss ergänzt werden, bevor die Seite erreichbar ist. |
